...
OUTPUT_FILES = {
		"no_data": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "intermediate", "v1.0", "tmQMg-L", "no_data.txt"),
		"sizes": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "intermediate", "v1.0", "tmQMg", "tmc_sizes.txt"),
		"no_coverage": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "intermediate", "v1.0", "tmQMg-L", "no_coverage.txt"),
		"viable": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "intermediate", "v1.0", "step_1_viable_tmcs.txt")
	}
