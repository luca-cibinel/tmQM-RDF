...
INPUT_FILES = {
		"viable": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "intermediate", "v1.0", "viable_tmcs.txt"),
		"ligands_atoms": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "intermediate", "v1.0", "tmQMg-L", "ligands_atoms_idx.csv"),
		...
		"tmQM_graphs": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "intermediate", "v1.0", "tmQM", "uNatQ_graphs"),
		"tmQMg_graphs": os.path.join(ROOT_DIR, "data", "raw", "tmQMseries", "data", "tmQMg", "v74.637k", "uNatQ_graphs"),
		"tmQMg_L_graphs": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "intermediate", "v1.0", "tmQMg-L", "uNatQ_graphs")
	}

OUTPUT_FILES = {
		"tmQM_RDF_ABox": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "data", "v1.0", "assertions"),
        "tmQM_RDF_TBox": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "data", "v1.0", "terminology")
	}
