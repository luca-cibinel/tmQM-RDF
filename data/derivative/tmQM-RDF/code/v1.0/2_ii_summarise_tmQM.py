...
INPUT_FILES = {
        "localised_tmcs": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "intermediate", "v1.0", "tmQMg", "localised_tmcs.csv"),
        ...
        "viable": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF", "intermediate", "v1.0", "step_2_i_viable_tmcs.txt")
	}
