...
INPUT_FILES = {
        ...
        "centres": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF-1Ksel", "intermediate", "v1.0", "centres.csv"),
        "details": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF-1Ksel", "intermediate", "v1.0", "details.csv"),
        "sizes": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF-1Ksel", "intermediate", "v1.0", "tmc_sizes.txt"),
        "ligands": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF-1Ksel", "intermediate", "v1.0", "%s", "ligands.csv"),
        "outliers": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF-1Ksel", "intermediate", "v1.0", "outliers.txt"),
        "tmQMg_graphs": os.path.join(ROOT_DIR, "data", "raw", "tmQMseries", "data", "tmQMg", "v74.548k", "u-NatQ_graphs")
    }

OUTPUT_FILES = {
        "selection": os.path.join(ROOT_DIR, "data", "derivative", "tmQM-RDF-1Ksel", "data", "v1.0", "%s", "1k_selection.csv")
    }
...
def extract_selection(candidates_tmc, tm_mode, sizes, centre_dist, detailed_info, size_dist, random_state):
    ...
    sizes_by_mc[:,-1] -= sizes_by_mc.sum(1) - np.array(sizes) # ensure that sizes is respected
