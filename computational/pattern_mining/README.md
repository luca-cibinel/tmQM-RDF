...
- [1_fm-gpm-transactional-setting_processpool-keepmappingsinfiles_deterministicsampling.pl](/computational/pattern_mining/1_fm-gpm-transactional-setting_processpool-keepmappingsinfiles_deterministicsampling.pl): this perl script performs the actual pattern mining. Among the available configs, a predicate blacklist filters out the forbidden predicates not removed in the previous step. An additional auxiliary script is available in support of this script:
